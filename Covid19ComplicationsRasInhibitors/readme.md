...
2. In `R`, use the following `devtools` command to install the COVID5ACESeverity package:
...
3. Once installed, you can execute the study by modifying and using the code below. For your convenience, this code is also provided under `extras/CodeToRun.R`:
	...
	outputFolder <- "c:/COVID5ACESeverity"
...
License
=======
The COVID5ACESeverity package is licensed under Apache License 2.0

Development
===========
COVID5ACESeverity was developed in ATLAS and R Studio.
