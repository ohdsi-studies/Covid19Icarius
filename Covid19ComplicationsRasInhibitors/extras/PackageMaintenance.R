...
OhdsiRTools::checkUsagePackage("Covid19ComplicationsRasInhibitors")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
shell("rm extras/Covid19ComplicationsRasInhibitors.pdf")
shell("R CMD Rd2pdf ./ --output=extras/Covid19ComplicationsRasInhibitors.pdf")
